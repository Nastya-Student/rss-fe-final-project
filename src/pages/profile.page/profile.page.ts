...
export class ProfilePage extends BasePage {
  ...
  private _userName?: HTMLHeadElement | undefined;
  ...
  public get userName(): HTMLHeadElement {
    if (!this._userName) {
  ...
  create(parent: HTMLElement): void {
    ...
    new HeadingsCreator(HEADINGS_TWO, {
      text: NOTIFICATIONS.profileTitle,
    ...
    this._userName = new HeadingsCreator(HEADINGS_ONE, {
